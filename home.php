				...
				<div class="panel panel-default">
					...
					<div class="form-group">
						...
						<div class="row">
							...
							<button type="button" id="editNumFiles" class="btn btn-default">Save number of files</button>
							<button type="button" visibility="hidden" id="editNumFiles" class="btn btn-default">Save changes</button>
						</div>	
					</div>
